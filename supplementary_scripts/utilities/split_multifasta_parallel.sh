...
split --numeric-suffixes=1 -n l/40 -a 4 "$input_file" temp_chunk_
ls temp_chunk_* | /home/groups/VEO/tools/parallel/v20230822/src/parallel -j 40 process_chunk {}
