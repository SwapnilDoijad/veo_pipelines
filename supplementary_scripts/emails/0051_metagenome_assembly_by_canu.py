...
message['Subject'] = 'veo_pipeline:0051_metagenome_assembly_by_canu run finished!!!'

# Add the email body
body = """ 
Hi User,

The pipeline 0051_metagenome_assembly_by_canu is finished. 

For a quick view of the ouput, please find attached summary.tsv file.

You can find more details at results/0051_metagenome_assembly_by_canu directory in your proejct folder.
...
file = 'results/0051_metagenome_assembly_by_canu/summary.tsv'
