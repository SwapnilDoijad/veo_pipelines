...
message['Subject'] = 'veo_pipeline:0991_calculate_abundance_from_fastq run finished!!!'

# Add the email body
body = """ 
Hi User,

The pipeline 0991_calculate_abundance_from_fastq is finished. 

For a quick view of the output, please find attached summary.tsv file.

You can find more details at results/0991_calculate_abundance_from_fastq directory in your proejct folder.
...
file1_pattern = 'results/0991_calculate_abundance_from_fastq/tmp/slurm/*.err'
file2_pattern = 'results/0991_calculate_abundance_from_fastq/tmp/slurm/*.out'
