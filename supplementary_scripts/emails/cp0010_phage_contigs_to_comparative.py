...
message['Subject'] = 'veo_pipeline: cp0010_phage_contigs_to_comparative run finished!!!'

# Add the email body
body = """ 
Hi User,

The pipeline cp0010_phage_contigs_to_comparative is finished. 

You can find more details in your project folder...

1. results/0050_genome_assembly_QC_by_quast
2. results/0072_QC_by_checkV
3. results/0064_identification_by_genomad
4. results/0083_annotation_prophage_by_pharokka
5. results/0171_comparative_genomics_core-pan_by_panaroo
...
# file = 'results/cp0010_phage_contigs_to_comparative/summary.tsv'
