...
message['Subject'] = 'veo_pipeline:0052_metagenome_assembly_by_fly run finished!!!'

# Add the email body
body = """ 
Hi User,

The pipeline 0052_metagenome_assembly_by_fly is finished. 

For a quick view of the output, please find attached summary.tsv file.

You can find more details at results/0052_metagenome_assembly_by_fly directory in your proejct folder.
...
file = 'results/0052_metagenome_assembly_by_fly/summary.tsv'
