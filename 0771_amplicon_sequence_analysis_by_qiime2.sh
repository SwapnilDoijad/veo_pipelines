...
## step-02-01 : Importing data
	...
	if [ ! -f $raw_files/paired-end-demux.qza ] ; then 
...
## step-02-02 : Checking the quality of the reads
	if [ ! -f $raw_files/paired-end-demux.qza.qzv ] ; then
		log "STARTED : step-02-02 : Checking the quality of the reads by qiime2"
		qiime demux summarize \
		--i-data $raw_files/paired-end-demux.qza \
		--o-visualization $raw_files/paired-end-demux.qza.qzv ## will show you the quality of the reads
	...
	## Visuliase $raw_files/paired-end-demux.qzv on https://view.qiime2.org/
...
## step-02-03 : Quality control and denoising
	...
	if [ ! -f $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza ]; then 
		log "STARTED : step-02-03 : Quality control and denoising by qiime2"
		qiime dada2 denoise-paired \
		--i-demultiplexed-seqs $raw_files/paired-end-demux.qza \
		--p-trim-left-f 20 \
		--p-trim-left-r 10 \
		--p-trunc-len-f 240 \
		--p-trunc-len-r 240 \
		--p-n-threads 20 \
		--o-representative-sequences $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza \
		--o-table $raw_files/paired-end-demux.qza.table-dada2.qza \
		--o-denoising-stats $raw_files/paired-end-demux.qza.stats-dada2.qza
...
## step-02-04 : FeatureTable and FeatureData summarize
	if [ ! -f $raw_files/paired-end-demux.qza.stats-dada2.qza.qzv ] ; then 
		log "STARTED : step-02-04 : FeatureTable and FeatureData summarize by qiime2"
		qiime feature-table summarize \
		--i-table $raw_files/paired-end-demux.qza.table-dada2.qza \
		--o-visualization $raw_files/paired-end-demux.qza.table-dada2.qza.qzv \
		--m-sample-metadata-file $metadata

		qiime feature-table tabulate-seqs \
		--i-data $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza \
		--o-visualization $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.qzv

		qiime metadata tabulate \
		--m-input-file $raw_files/paired-end-demux.qza.stats-dada2.qza \
		--o-visualization $raw_files/paired-end-demux.qza.stats-dada2.qza.qzv ## important statistics to view
	...
	## Visuliase $raw_files/paired-end-demux.qza.stats-dada2.qza.qzv on https://view.qiime2.org/
	## and then decide the cutoff for next step. 
...
## step-02-05 : Taxonomic classification
	...
	if [ ! -f $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.taxonomy.qza.qzv ]; then
		...
		--i-reads $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza \
		--o-classification $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.taxonomy.qza

		# summerize taxonomy info
		qiime metadata tabulate \
		--m-input-file $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.taxonomy.qza \
		--o-visualization $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.taxonomy.qza.qzv

		## export taxonomy info 
		## this will give you the taxonomy (assignment of each id to taxonomic lineage) info in a tsv file
		qiime tools export \
		--input-path $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.taxonomy.qza \
		--output-path $raw_files/taxonomy_exported
...
## step-02-06 : Remove non-bacterial sequence and singletons
	...
	if [ ! -f $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.bacteria_only.qza.singleton_filtered_seq.qza.qzv ]; then 
		log "STARTED : step-02-06 : Remove non-bacterial sequence and singletons by qiime2"

		qiime taxa filter-table \
		--i-table $raw_files/paired-end-demux.qza.table-dada2.qza \
		--i-taxonomy $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.taxonomy.qza \
		--p-include Bacteria,Archaea \
		--p-exclude eukaryota,mitochondria,chloroplast \
		--o-filtered-table $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza

		qiime taxa filter-seqs \
		--i-sequences $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza \
		--i-taxonomy $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.taxonomy.qza \
		--p-include Bacteria,Archaea \
		--p-exclude eukaryota,mitochondria,chloroplast \
		--o-filtered-sequences $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.bacteria_only.qza

		## filter samples
		qiime feature-table filter-features \
		--i-table $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza \
		--p-min-samples 1 \
		--p-min-frequency 2 \
		--o-filtered-table $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza.singleton_filtered-table.qza

		## remove singletons sequence
		qiime feature-table filter-seqs \
		--i-data $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.bacteria_only.qza \
		--i-table $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza.singleton_filtered-table.qza \
		--o-filtered-data $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.bacteria_only.qza.singleton_filtered_seq.qza

		# FeatureTable and FeatureData summarize
		qiime feature-table summarize \
		--i-table $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza.singleton_filtered-table.qza \
		--o-visualization $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza.singleton_filtered-table.qza.qzv \
		--m-sample-metadata-file $metadata

		qiime feature-table tabulate-seqs \
		--i-data $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.bacteria_only.qza.singleton_filtered_seq.qza \
		--o-visualization $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.bacteria_only.qza.singleton_filtered_seq.qza.qzv
...
## step-02-07 : Exporting feature-table, tabulate feature-table with taxonomy
	...
	if [ ! -f $raw_files/exported_unfiltered/feature-table-filtered.tsv ] ; then 
		...
		qiime tools export \
		--input-path $raw_files/paired-end-demux.qza.table-dada2.qza \
	...
	if [ ! -f $raw_files/exported/feature-table-filtered.tsv ] ; then 
		...
		qiime tools export \
		--input-path $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza.singleton_filtered-table.qza \
	...
	## step-02-06-03: tabulate feature-table with taxonomy
		if [ ! -f $raw_files/exported_taxonomy/feature-table.biom.tsv ] ; then
			...
			# --m-input-file $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza.singleton_filtered-table.qza \
			biom convert \
...
## step-02-08: Phylogenetic reconstruction (optional but recommended):
	...
	if [ ! -f $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.bacteria_only.qza.singleton_filtered_seq.qza.rooted-tree.qza ]; then
		log "STARTED : step-02-07 : Phylogenetic reconstruction by qiime2"
		qiime phylogeny align-to-tree-mafft-fasttree \
		--p-n-threads 40 \
		--i-sequences $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.bacteria_only.qza.singleton_filtered_seq.qza \
		--o-alignment $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.bacteria_only.qza.singleton_filtered_seq.qza.alignment.qza \
		--o-masked-alignment $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.bacteria_only.qza.singleton_filtered_seq.qza.masked-aligned.qza \
		--o-tree $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.bacteria_only.qza.singleton_filtered_seq.qza.tree.qza \
		--o-rooted-tree $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.bacteria_only.qza.singleton_filtered_seq.qza.rooted-tree.qza

		qiime tools export \
		--input-path $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.bacteria_only.qza.singleton_filtered_seq.qza.rooted-tree.qza \
		--output-path $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.bacteria_only.qza.singleton_filtered_seq.qza.rooted-tree.qza.nwk
...
## step-02-09 : core-metrics-phylogenetic (optional)
	...
	# 	--i-phylogeny $raw_files/paired-end-demux.qza.rep-seqs-dada2.qza.bacteria_only.qza.singleton_filtered_seq.qza.rooted-tree.qza \
	# 	--i-table $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza.singleton_filtered-table.qza \
...
## step-02-10 : Alpha and beta diversity analysis
	...
	if [ ! -f $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza.singleton_filtered-table.qza.braycurtis-distance.qza ] ; then
		...
		--i-table $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza.singleton_filtered-table.qza \
		--p-metric shannon \
		--o-alpha-diversity $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza.singleton_filtered-table.qza.shannon-alpha.qza

		qiime diversity alpha-group-significance \
		--i-alpha-diversity $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza.singleton_filtered-table.qza.shannon-alpha.qza \
		--m-metadata-file $metadata \
		--o-visualization $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza.singleton_filtered-table.qza.shannon-alpha.qzv

		qiime tools export \
		--input-path $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza.singleton_filtered-table.qza.shannon-alpha.qza \
		--output-path $raw_files/alpha_diversity_export

		## beta diversity
		qiime diversity beta \
		--i-table $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza.singleton_filtered-table.qza \
		--p-metric braycurtis \
		--o-distance-matrix $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza.singleton_filtered-table.qza.braycurtis-distance.qza

		qiime diversity pcoa \
		--i-distance-matrix $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza.singleton_filtered-table.qza.braycurtis-distance.qza \
		--o-pcoa $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza.singleton_filtered-table.qza.braycurtis-pcoa.qza

		qiime emperor plot \
		--i-pcoa $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza.singleton_filtered-table.qza.braycurtis-pcoa.qza \
		--m-metadata-file $metadata \
		--o-visualization $raw_files/paired-end-demux.qza.table-dada2.qza.bacteria_only.qza.singleton_filtered-table.qza.braycurtis-emperor.qzv
